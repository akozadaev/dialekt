package ru.tsutmb.views.authors;
...
import ru.tsutmb.data.service.SamplePersonService;
...
public class AuthorsView extends Div {
    ...
    public AuthorsView(SamplePersonService personService) {
        addClassName("authors-view");
